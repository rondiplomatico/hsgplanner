...
public class HSGSolverTest {
	...
	Person A1 = new Person("A1", "M1", 0, true);
	Person A2 = new Person("A1", "F1", 0, true);
	Person A3 = new Person("A2", "HA", 0, true);
	...
	Game F21 = new Game(date, i1300_1600.getStart(), HSGApp.GA, "F2", "F2", "Foobars", true, "LL");
	Game F11 = new Game(date, i1300_1600.getStart().plus(2L, ChronoUnit.HOURS), HSGApp.GA, "F1", "F1", "Foobars", true, "BWOL");
	Game M11 = new Game(date, i1300_1600.getStart().plus(4L, ChronoUnit.HOURS), HSGApp.GA, "M1", "M1", "Foobars", true, "BK");
