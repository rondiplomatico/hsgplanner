...
public final class NativeLoaderCplex {
    ...
    private static final String NIX_VERSION = "1263"; // Library version for unix, src/main/resources/NIX_VERSION/x86-64_linux
    private static final String WIN_VERSION = "1262"; // Library version for windows, src/main/resources/WIN_VERSION/x64_win64
    ...
    /*
     * each private static is owned by a JVM, each JVM needs to load Cplex libs to run Cplex
     */
            ...
            if (osName.startsWith("win")) {
                if (osArch.contains("64")) {
                    ...
                    libs = Arrays.asList(CPLEX_DLLSTART + WIN_VERSION + ".dll",
                                         ...
                                         CPLEX_DLLSTART + WIN_VERSION + "remote.dll",
                                         CPLEX_DLLSTART + WIN_VERSION + "remotejni.dll",
                ...
                libs = Arrays.asList(LIBCPLEX_SOSTART + NIX_VERSION + ".so",
                                     ...
                                     LIBCPLEX_SOSTART + NIX_VERSION + "remote.so",
                                     LIBCPLEX_SOSTART + NIX_VERSION + "remotejni.so",
