...
public class Problem {
	...
	@Getter
	protected final List<SOS> soss = new ArrayList<>();
	@Getter
	protected final List<GUB> gubs = new ArrayList<>();
	 ...
	 *
	 * @param objective the objective function
	 * @param optType   the optimization type
	 */
	 ...
	 *
	 * @param objective the objective function
	 * @param optType   the optimization type (min,max)
	 */
	 ...
	 *
	 * @param optType the optimization type to be set
	 */
	 ...
	 *
	 * @param variable the lower bound
	 ...
	 *
	 * @param variable the upper bound
	 ...
	 */
	public void setVarBoundsAndType(final Number lower, final Object variable, final Number upper,
			final Class<?> type) {
		setVarLowerBound(variable, lower);
		setVarUpperBound(variable, upper);
