...
public class HSGSolver {
    ...
    public static List<Zuordnung> solve(final JavaRDD<Zuordnung> all) {
        ...
        /*
         * Pro Person nur ein Dienst gleichzeitig.
         * Da die Dienste beliebig überschneiden können, muss man vorher disjunkt aufteilen.
         */
        ...
        List<Zuordnung> selected = allList.stream()
    ...
    private static void addN3NurGleicheTeamsInGleichenDiensten(final JavaRDD<Zuordnung> all, final Problem problem) {
        all.mapToPair(z -> new Tuple2<>(new Tuple2<>(z.getDienst(), z.getPerson()), z.varName()))
    ...
    private static void addN1EinePersonProDienst(final JavaRDD<Zuordnung> all, final Problem problem) {
        all.mapToPair(t -> new Tuple2<>(t.getDienst(), t.varName()))
           .groupByKey()
    ...
    private static void addZ1GleichVielArbeitsZeit(final JavaRDD<Zuordnung> all, final Problem problem, final Linear target) {
        /*
         * Alle gleich viel Arbeitszeit.
         * Die gesamtarbeitszeit soll pro person nicht von der (aktuellen) durchschnittlichen arbeitszeit abweichen.
         */
