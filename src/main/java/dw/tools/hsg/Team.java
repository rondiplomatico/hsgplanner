...
public enum Team {
	...
	M1(1.0, HSGInterval.ALL_DAY, true), M2(1.0, HSGInterval.ALL_DAY), M3(1.0, HSGInterval.ALL_DAY), M4(1.0,
			HSGInterval.ALL_DAY),
	F1(1.0, HSGInterval.ALL_DAY, true), F2(1.0, HSGInterval.ALL_DAY, true), F3(1.0, HSGInterval.ALL_DAY),
	...
	mC1(0.0, HSGInterval.EMPTY), wC1(0.0, HSGInterval.EMPTY),
	mC2(0.0, HSGInterval.EMPTY), wC2(0.0, HSGInterval.EMPTY),
	...
	gF1(0.0, HSGInterval.EMPTY), gF2(0.0, HSGInterval.EMPTY),
