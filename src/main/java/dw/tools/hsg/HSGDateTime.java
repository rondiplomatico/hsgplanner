...
/**
 * HSGDateTime is a Timestamp Wrapper for PBK.
 * A DateTime is "YYYY-MM-HH hh:mm:ss.sss". Usage: for all Dates which needs year, month and day, hour, miute and day.
 *
 * @author mattist
 * @since 01.08.2016
 */
public class HSGDateTime implements Serializable, Comparable<HSGDateTime> {
     ...
     *            the second
     */
    public HSGDateTime(final int year, final int month, final int day, final int hour, final int minute, final int second) {
    ...
    /**
     * Returns a HSGDateTime of the current date-time from the system clock in the default time-zone
     *
     * @return the HSGDateTime
     */
    ...
    /**
     * New HSGDateTime from an ISO formatted date, without the letter 'T' as delimiter.
     * ISO format is e.g. '2017-12-03T10:15:30'.
     *
     * @param date
     *            the date
     * @return the HSGDateTime
    ...
    /**
     * New HSGDateTime from a PBK Timestamp formatted date. PBK Timestamp formatted date is "yyyyMMddHHmm" format.
     *
     * @param date
     *            the date
     * @return the HSGDateTime
    ...
    /**
     * New HSGDateTime from a Timestamp formatted date. Timestamp formatted date is "yyyyMMddHHmmss" format.
     *
     * @param date
     *            the date
     * @return the HSGDateTime
